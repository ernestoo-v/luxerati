    ...
    <main>
        ...
        <div id="div1">
            <form id="formulario" action="save.php" method="POST">
                <input type="text" name="nombre_sorteo" placeholder="Insertar el nombre del sorteo" required>
                <input type="text" name="descripcion_sorteo" placeholder="Insertar la descripción del sorteo" required>
                <input type="text" name="fecha_fin_sorteo" placeholder="Fecha de finalizacion" required>
