    ...
    <main>
        ...
        <div id="div1">
            <form id="formulario" action="save.php" method="POST">
                <input type="text" name="nombre_evento" placeholder="Insertar el nombre del evento" required>
                <input type="text" name="fecha_evento" placeholder="Insertar la fecha del eventos" required>
                <input type="text" name="descripcion_evento" placeholder="Insertar la descripcion del evento" required>
                <input type="text" name="href_evento" placeholder="Insertar la url del evento" required>
