...
$eventos = Database::findById($id, $tabla);
?>
<?php
    ...
    <main>
        ...
        <div id="div1">
            <form id="formulario" action="update.php" method="POST">
                <input type="hidden" name="id_eventos" value="<?php echo $eventos['id'] ?>" required>
                <input type="text" name="nombre_evento" value="<?php echo $eventos['nombre_evento'] ?>" required>
                <input type="text" name="fecha_evento" value="<?php echo $eventos['fecha_evento'] ?>" required>
                <input type="text" name="descripcion_evento" value="<?php echo $eventos['descripcion_evento'] ?>" required>
                <input type="text" name="href_evento" value="<?php echo $eventos['href_evento'] ?>" required>
