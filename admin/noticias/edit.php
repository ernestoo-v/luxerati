...
$noticias = Database::findById($id, $tabla);
?>
<?php
    ...
    <main>
        ...
        <div id="div1">
            <form id="formulario" action="update.php" method="POST">
                <input type="hidden" name="id_noticias" value="<?php echo $noticias['id'] ?>" required>
                <input type="text" name="nombre_noticias" value="<?php echo $noticias['nombre_noticias'] ?>" required>
                <input type="text" name="href_noticia" value="<?php echo $noticias['href_noticia'] ?>" required>
