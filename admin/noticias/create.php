    ...
    <main>
        ...
        <div id="div1">
            <form id="formulario" action="save.php" method="POST">
                <input type="text" name="nombre_noticias" placeholder="Insertar el nombre de la noticia" required>
                <input type="text" name="href_noticia" placeholder="Insertar la url de la noticia" required>
