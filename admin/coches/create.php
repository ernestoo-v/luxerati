    ...
    <main>
        ...
        <div id="div1">
            <form id="formulario" action="save.php" method="POST">
                <input type="text" name="marca_coche" placeholder="Insertar la marca del coche" required>
                <input type="text" name="modelo_coche" placeholder="Insertar el modelo del coche" required>
                <input type="text" name="ano_coche" placeholder="Insertar el año del coche" required>
                <input type="text" name="precio_coche" placeholder="Insertar el precio del coche" required>
                <input type="text" name="color_coche" placeholder="Insertar el color del coche" required>

                <input type="text" name="velocidad_coche" placeholder="Insertar velocidad 1-100" required>
                <input type="text" name="potencia_coche" placeholder="Insertar potencia CV" required>
                <input type="text" name="consumo_coche" placeholder="Insertar consumo" required>
