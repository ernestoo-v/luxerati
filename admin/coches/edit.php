...
$coches = Database::findById($id, $tabla);
?>
<?php
    ...
    <main>
        ...
        <div id="div1">
            <form id="formulario" action="update.php" method="POST">
                <input type="hidden" name="id_coche" value="<?php echo $coches['id'] ?>" required>
                <input type="text" name="marca_coche" value="<?php echo $coches['marca_coche'] ?>" required>
                <input type="text" name="modelo_coche" value="<?php echo $coches['modelo_coche'] ?>" required>
                <input type="text" name="ano_coche" value="<?php echo $coches['ano_coche'] ?>" required>
                <input type="text" name="precio_coche" value="<?php echo $coches['precio_coche'] ?>" required>
                <input type="text" name="color_coche" value="<?php echo $coches['color_coche'] ?>" required>
                <input type="text" name="velocidad_coche" value="<?php echo $coches['velocidad_coche'] ?>" required>
                <input type="text" name="potencia_coche" value="<?php echo $coches['potencia_coche'] ?>" required>
                <input type="text" name="consumo_coche" value="<?php echo $coches['consumo_coche'] ?>" required>
