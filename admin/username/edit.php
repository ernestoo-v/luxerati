    ...
    <main>
        ...
        <div id="div1">
            <form id="formulario" action="update.php" method="POST">
                <input type="hidden" name="id_usuario" value="<?php echo $sorteos['id'] ?>" required>
                <input type="text" name="nombre_usuario" value="<?php echo $sorteos['username'] ?>" required>
                <input type="text" name="email_usuario" value="<?php echo $sorteos['email'] ?>" required>
                <input type="text" name="contraseña_usuario" value="<?php echo $sorteos['password'] ?>" required>
                <input type="text" name="rol_usuario" value="<?php echo $sorteos['rol_id'] ?>" required>
