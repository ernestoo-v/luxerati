    ...
    <main>
        ...
        <div id="div1">
            <form id="formulario" action="save.php" method="POST">
                <input type="text" name="username" placeholder="Insertar el nombre del usuario" required>
                <input type="text" name="email" placeholder="Insertar el email del usuario" required>
                <input type="text" name="password" placeholder="Inserte la contraseña del usuario" required>
                <input type="text" name="rol_id" placeholder="Inserte el rol del usuario" required>
